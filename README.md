# Agri Empower Africa - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Agri Empower Africa**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@agriempowerafrica.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@agriempowerafrica.cm` | `user123` | |
...
*   **Contact :** contact@agriempowerafrica.cm